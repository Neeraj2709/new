...
const SetNewPasswordForm = ({ onSwitchForm }) => {
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      onSwitchForm("password-reset-success"); // Move to the "password reset success" step
    },
  });
      ...
      <div className="flex bg-white shadow-lg rounded-lg overflow-hidden w-full max-w-4xl">
        ...
        <div className="w-1/3 bg-gray-100 p-6">
          <div className="flex flex-col items-center">
            <div className="text-blue-600 text-2xl font-bold mb-6">Choose a password</div>
        ...
        <div className="w-2/3 p-10">
          ...
          <p className="text-gray-500 mt-2">Please set your new password.</p>
